                ...
                <div className="product_track_content">
                  ...
                  <div className="details bg-gray-100 p-10 rounded-md">
                    <div className="track_item flex mb-4">
                      ...
                      <i class="fa-solid fa-lock " className="bg-white p-3 rounded-md w-full"></i>
                      </div>
                    ...
                    <div className="btn mt-2 flex justify-center">
                        ...
                        <span><i class="fa-solid fa-arrow-right mt-2.5 pl-2"></i></span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-6">
                <div className="product_track_content">
                  ...
                  <div className="details bg-gray-100 p-10 rounded-md">
                    <div className="track_item flex mb-4">
                      <div className="track_icon mr-5   ">
                        <img src="" alt="" className="bg-white p-3 rounded-md w-full"/>
                      </div>
                      <div className="content">
                        <h4 className="title text-[18px] text-black font-semibold pb-1">
                          Track Your Order
